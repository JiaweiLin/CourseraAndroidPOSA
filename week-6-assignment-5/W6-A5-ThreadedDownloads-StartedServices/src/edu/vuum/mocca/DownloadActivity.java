...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	String imagePath = data.getString("PATHNAME");
            	
            	activity.displayBitmap(imagePath);
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent threadPoolIntent = ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, getUrlString());
